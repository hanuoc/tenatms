    ...
    if (user.permissions != []) {
      ...
      switch (action) {
        ...
        case 'delete':
          ...
          break;
        case 'cancel':
          var hasPermission: number = permission.findIndex(x => x.FunctionId == functionId && x.CanCancel == true);
          if (hasPermission != -1)
            result = true;
          break;
        case 'read':
          ...
          break;
        case 'readAll':
          var hasPermission: number = permission.findIndex(x => x.FunctionId == functionId && x.CanReadAll == true);
          if (hasPermission != -1)
            result = true;
          break;
        case 'readAllFixDelegate':
          var hasPermission: number = permission.findIndex(x => x.FunctionId == functionId);
          if (hasPermission != -1 && roles.findIndex(x => x == "Admin") != -1)
            result = true;
          break;
        case 'readAllHR':
          var hasPermission: number = permission.findIndex(x => x.FunctionId == functionId && x.CanReadAll == true);
          if (hasPermission != -1 || roles.findIndex(x => x == "HR") != -1)
            result = true;
          break;
        case 'readAllAdmin':
          var hasPermission: number = permission.findIndex(x => x.FunctionId == functionId && x.CanReadAll == true);
          if (hasPermission != -1 || roles.findIndex(x => x == "Admin") != -1)
            result = true;
          break;
        case 'readAllGeneralAdmin':
          if (roles.findIndex(x => x == "SuperAdmin") != -1)
            result = true;
          break;
        ...
        case 'createDelegateGroupLead':
          if (roles.findIndex(x => x == "GroupLead") != -1)
            result = true;
          break;
          case 'caseRoleSuperAdmin':
          if (roles.findIndex(x => x == "SuperAdmin") != -1)
            result = true;
          break;
      }
