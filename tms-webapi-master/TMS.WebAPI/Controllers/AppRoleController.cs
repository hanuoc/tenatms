...
using TMS.Web.Models.DataContracts;
    ...
    public class AppRoleController : ApiControllerBase
    {
        ...
        public async Task<HttpResponseMessage> GetAll(HttpRequestMessage request)
        {
            return await CreateHttpResponse(request, () =>
            {
                ...
                {
                    //Loại role superadmin bằng id
                    if (role.Name.Equals(CommonConstants.RoleAdminName))
                    {
                        model.Remove(role);
                        break;
                    }
        ...
        [HttpGet]
        public async Task<HttpResponseMessage> GetAllPermission(HttpRequestMessage request, string functionId)
        {
            return await CreateHttpResponse(request, () =>
            {
