...
namespace TMS.Web.Controllers
{
    ...
    public class AnnouncementController : ApiControllerBase
    {
        ...
        [HttpGet]
        public async Task<HttpResponseMessage> GetTopMyAnnouncement(HttpRequestMessage request)
        {
        ...
        [Route("getall")]
        [HttpGet]
        public async Task<HttpResponseMessage> GetAll(HttpRequestMessage request, int pageIndex, int pageSize)
        {
            return await CreateHttpResponse(request, () =>
            {
                HttpResponseMessage response = null;
